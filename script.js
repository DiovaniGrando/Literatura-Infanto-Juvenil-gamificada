...
const MEMORY_MEANINGS = [
...

  {
    ...
    author: "Ruth Rocha",
    concept: "Linguagem e construção de sentidos",
    theme:
...
/* ==========================================================
   CARREGAMENTO SEM BLOQUEAR OS BOTÕES
========================================================== */
  ...
  const update =
    () => {
      ...
      $("loadingDetails").textContent =
        `${complete} de ${RESOURCES.length} recursos preparados`;
...
function openQuestion(index) {
  ...
  $("questionStep").textContent =
    `DESAFIO ${stageIndex + 1} DE 10 · PERGUNTA ${used} DE 20`;
...
/* Tecla ESC fecha o painel de informações */
